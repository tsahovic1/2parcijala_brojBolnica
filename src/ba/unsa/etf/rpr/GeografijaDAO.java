...
public class GeografijaDAO {
    ...
    public void dodajGrad(Grad grad) {
        try {
            ...
            if(grad instanceof RazvijeniGrad) dodajGradUpit.setInt(5, 1);
            if(grad instanceof SrednjeRazvijeniGrad) dodajGradUpit.setInt(5, 2);
            if(grad instanceof NerazvijeniGrad) dodajGradUpit.setInt(5, 3);
    ...
    public void izmijeniGrad(Grad grad) {
        try {
            ...
            if(grad instanceof RazvijeniGrad) promijeniGradUpit.setInt(4, 1);
            if(grad instanceof SrednjeRazvijeniGrad) promijeniGradUpit.setInt(4, 2);
            if(grad instanceof NerazvijeniGrad) promijeniGradUpit.setInt(4, 3);
